...
class Problem(object):
    ...
    def __init__(self, n_agent=20, m=1000, dim=40, graph_type='er', graph_params=None, regularization=None, r=0, dataset='a9a', sort=False, shuffle=False, normalize_data=False, gpu=False):
        ...
        if dataset == 'random':
            ...
            self.X_train, self.Y_train, self.X_test, self.Y_test = self.data_dict[self.dataset]().load()
